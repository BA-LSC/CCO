...
export const organizations = sqliteTable("organizations", {
  ...
  cloudflareSecretsStoreId: text("cloudflare_secrets_store_id"),
  pcoClientSecretConfigured: integer("pco_client_secret_configured", { mode: "boolean" }),
  pcoWebhookSecretsConfigured: integer("pco_webhook_secrets_configured", { mode: "boolean" }),
  giphyApiKeyConfigured: integer("giphy_api_key_configured", { mode: "boolean" }),
  vapidPrivateKeyConfigured: integer("vapid_private_key_configured", { mode: "boolean" }),
  cloudflareApiTokenConfigured: integer("cloudflare_api_token_configured", { mode: "boolean" }),
  cloudflareR2AccessKeyConfigured: integer("cloudflare_r2_access_key_configured", { mode: "boolean" }),
  cloudflareR2SecretAccessKeyConfigured: integer("cloudflare_r2_secret_access_key_configured", {
    mode: "boolean",
  }),
