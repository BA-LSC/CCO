...
export const organizations = pgTable("organizations", {
  ...
  pcoClientSecretConfigured: boolean("pco_client_secret_configured"),
  pcoWebhookSecretsConfigured: boolean("pco_webhook_secrets_configured"),
  giphyApiKeyConfigured: boolean("giphy_api_key_configured"),
  vapidPrivateKeyConfigured: boolean("vapid_private_key_configured"),
  cloudflareApiTokenConfigured: boolean("cloudflare_api_token_configured"),
  cloudflareR2AccessKeyConfigured: boolean("cloudflare_r2_access_key_configured"),
  cloudflareR2SecretAccessKeyConfigured: boolean("cloudflare_r2_secret_access_key_configured"),
  cloudflarePlatformProvisionedAt: timestamp("cloudflare_platform_provisioned_at"),
