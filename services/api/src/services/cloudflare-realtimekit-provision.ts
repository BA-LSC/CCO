...
/** Map RealtimeKit preset names to CCO host/member/guest roles. */
...
export type ProvisionRealtimeKitParams = {
  ...
  /** When true, create a RealtimeKit app if none is found. Used by integrations save and future setup. */
  autoCreateApp?: boolean;
};

/**
 * Resolve Cloudflare account, RealtimeKit app, and preset mapping from an API token.
 * Intended for integrations settings today and first-time setup in the future.
 */
